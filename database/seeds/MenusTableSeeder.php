...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->endDropdown();
        $this->insertLink('guest,user,admin', 'Widgets', '/widgets', 'cil-calculator');
        $this->insertTitle('guest,user,admin', 'Extras');
        $this->beginDropdown('guest,user,admin', 'Pages', 'cil-star');
        $this->insertLink('guest,user,admin', 'Login', '/login');
        $this->insertLink('guest,user,admin', 'Register', '/register');
        $this->insertLink('guest,user,admin', 'Error 404', '/404');
        $this->insertLink('guest,user,admin', 'Error 500', '/500');
        $this->endDropdown();
